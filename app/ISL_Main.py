...
class VideoCamera(object):
    ...
    def get_frame(self):
        ...
        # I am using Motion JPEG, but OpenCV defaults to capture raw images,
        # so I must encode it into JPEG in order to correctly display the
        # video stream.
...
class camera():
    ...
    # path to the dataset
    paths = ['/home/jonghyo/project/aihandDetection/ISL_dataset']
    # tensorflow  /home/jonghyo/.local/lib/python3.6/site-packages
    ...
    def trainData():
        ...
        model.save('/home/Python/aihandDetection/keras.model)

        # run this if model is already saved on disk.
        model = keras.models.load_model('/home/Python/aihandDetection/keras.model')
    ...
    def identifyGesture(handTrainImage):
        ...
        # cv2.imwrite("/home/Python/aihandDetection/a0.jpeg", handTrainImage)
        ...
        # background.save("/home/Python/aihandDetection/a.jpeg")
